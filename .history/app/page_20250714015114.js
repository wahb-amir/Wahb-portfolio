...
export default function Home() {
  return (
    <main className="relative flex flex-col justify-center items-center min-h-screen px-4 xs:px-6 text-center bg-[#0a0f1a] text-white overflow-hidden">
      <Particles
        id="tsparticles"
        init={particlesInit}
      ...
      <motion.div
        ...
        className="z-10 mt-8 xs:mt-10"
      >
        <div className="mx-auto w-[150px] xs:w-[200px] 3xl:w-[300px]">
          <Avatar />
        </div>
        ...
        <h2 className="text-base xs:text-lg sm:text-2xl mt-6 font-medium max-w-xl mx-auto text-slate-200">
          <Typewriter
            words={[
              "Full-Stack Developer | Building Scalable Web Solutions",
              "Passionate About Clean, Efficient Code & UX",
              "Expert in Modern Frontend & Backend Technologies",
              "Delivering Performance-Optimized, Secure Applications",
