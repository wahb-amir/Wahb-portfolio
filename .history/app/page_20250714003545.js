...
//   background: { color: "#111827" }, // just so we can SEE it
//   particles: {
//     number: { value: 60 },
//     size: { value: 4 },
...
//   },
// };
// Import only react wrapper and "loadFull"
// No extra plugins for now
import Particles from "@tsparticles/react";
import { loadFull } from "tsparticles";

const particlesInit = async (engine) => {
  console.log("Particles engine ready", engine);
  await loadFull(engine);
};
...
return (
  <div style={{ height: "100vh", background: "#111827" }}>
    <Particles id="test" init={particlesInit} options={particlesOptions} />
  </div>
);
