...
export default function TestParticles() {
  ...
  const options = {
    fullScreen: { enable: true }, // Canvas covers entire screen
    background: { color: "#000" }, // Make it black so you can see white dots
    particles: {
      number: { value: 30 },
      links: { enable: true },
      move: { enable: true, speed: 1 },
  ...
  return (
    <Particles id="tsparticles-test" init={particlesInit} options={options} />
  );
}
