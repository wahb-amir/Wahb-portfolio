...
const particlesOptions = {
  ...
  particles: {
    ...
    links: {
      enable: true,
      distance: 60, // 🔼 increased from 20
      color: "#00dfd8",
      opacity: 0.4,
      width: 1,
      triangles: {
        enable: false, // 📴 off for perf
      },
      shadow: {
        enable: false, // 📴 goodbye GPU meltdown
      },
    },
    move: {
      enable: true,
      speed: 1.2, // 🔻 slightly slower = smoother
      direction: "none",
      outModes: {
        default: "bounce",
      },
    ...
    size: {
      value: { min: 2, max: 3.5 }, // 🎯 slightly smaller max size
    },
    shape: {
      type: "circle",
    },
  ...
  interactivity: {
    ...
    modes: {
      grab: {
        distance: 100, // 🔻 toned down grab range
        links: {
          opacity: 0.8,
        },
      },
