...
export default function Home() {
  return (
    <main className="relative flex flex-col justify-start xs:justify-center items-center min-h-screen px-4 xs:px-6 text-center bg-[#0a0f1a] text-white overflow-hidden">
      <Particles
        id="tsparticles"
        init={particlesInit}
