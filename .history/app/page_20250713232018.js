...
import { loadLinksPreset } from "tsparticles-preset-links"; // 💥 You forgot this!

const particlesInit = async (engine) => {
  await loadFull(engine); // loads all base features
  await loadLinksPreset(engine); // 💡 add this line to load the "links" preset!
};
