...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      <BackgroundEffect />
      <form onSubmit={handleSubmit} className="space-y-5 relative z-10 max-w-xl w-full">
        {/* inputs */}
        <input
          type="text"
          name="name"
            ...
            className={`w-full h-full rounded-full font-medium tracking-wide transition-all duration-300 relative z-10
              ${
                status === "sending"
                  ...
                  : "bg-green-200 hover:bg-gray-300 text-black dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white"
              }`}
          >
            {status === "sending"
              ? ""
