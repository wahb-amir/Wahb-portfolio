      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="bg-gray-800 p-4 rounded-lg text-center">
            ...
            <p className="text-sm text-gray-400">Full-Stack Projects Deployed</p>
          </div>
          <div className="bg-gray-800 p-4 rounded-lg text-center">
        ...
        <div className="mb-16">
          ...
          <ul className="list-disc pl-5 text-gray-300 space-y-2">
            <li>Currently focused on building clean, scalable full-stack apps</li>
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4 border-l-2 border-pink-500 pl-4">
            <div>
              <span className="font-bold">March 2025:</span> Started with HTML/CSS
            </div>
            <div>
              <span className="font-bold">April 2025:</span> Mastered JavaScript fundamentals
            </div>
            <div>
              <span className="font-bold">May 2025:</span> Built my first React app
            </div>
            <div>
              <span className="font-bold">June 2025:</span> Launched full-stack projects with Node & Mongo
            </div>
            <div>
              <span className="font-bold">Today:</span> Hosting apps on my own Linux VPS & learning every day
            </div>
          </div>
        </div>
