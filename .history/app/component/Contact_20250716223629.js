...
export default function ContactForm() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-20 bg-white/80 dark:bg-white/10 backdrop-blur-lg p-8 rounded-2xl border border-gray-200 dark:border-white/20 shadow-[0_0_30px_rgba(0,255,255,0.1)] text-black dark:text-white transition-colors">
      ...
      <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
        ...
        <div className="relative h-12 w-full overflow-hidden rounded-full">
          ...
          >
            ...
            {status === "sending" && (
              <div className="absolute bottom-[7px] left-0 w-[90%] h-1 bg-white/20 translate-y-[-50%] z-0" />
            )}
          </button>
        ...
        {status === "sent" && (
          <p className="text-center mt-3 text-green-600 dark:text-green-400 animate-fade-in">
