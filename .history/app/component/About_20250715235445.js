...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="max-w-4xl mx-auto px-6 py-20 text-gray-800 dark:text-slate-300 w-screen h-screen flex flex-col items-center justify-start"
      style={{
        backgroundImage: isDark
          ? "radial-gradient(circle at top left, #00b1ff88, transparent 70%), radial-gradient(circle at bottom right, #00dfd088, transparent 70%)"
          : "radial-gradient(circle at top left, #7f5af044, transparent 70%), radial-gradient(circle at bottom right, #00dfd844, transparent 70%)",
      }}
    >
      <motion.div
