...
export default function SkillsCloud() {
  ...
  return (
    <section
      id="skills"
      className="relative flex flex-col justify-start items-center min-h-screen px-4 sm:px-6 text-center bg-[#0a0f1a] text-white overflow-hidden pt-[env(safe-area-inset-top)] pb-16"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-4 mt-12 mb-8 sm:mb-12">
        <button
