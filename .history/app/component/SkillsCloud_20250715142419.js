...
// Returns a responsive min-height value based on device height
const getMinHeight = () => {
  if (typeof window === "undefined") return "100vh";
  // For tall devices, use a larger min-height
...
export default function SkillsCloud() {
  ...
  const learningPositions = learningSkills.map((skill, i) => {
    ...
    <section
      id="skills"
      className="relative flex flex-col items-center px-4 sm:px-6 pt-[env(safe-area-inset-top)] pb-12 bg-[#0a0f1a] text-white text-center overflow-hidden"
      style={{
        minHeight: minHeight,
        backgroundImage:
