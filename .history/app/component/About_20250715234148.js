      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4 border-l-2 border-pink-500 pl-4">
            <div>
              <span className="font-bold">2019:</span> First HTML/CSS site → 💥
            </div>
            <div>
              <span className="font-bold">2020:</span> JavaScript clicked. Chaos
              followed.
            </div>
            <div>
              <span className="font-bold">2021:</span> Full-stack builds, Git
              mastery
            </div>
            <div>
              <span className="font-bold">2022–Now:</span> Freelancing & API
              wizardry
            </div>
          </div>
        </div>
