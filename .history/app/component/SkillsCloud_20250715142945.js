...
export default function SkillsCloud() {
  ...
  // 💡 Fixed: Skill positions for cloud layout
  ...
  return (
    <section
      id="skills"
      className="relative flex flex-col items-center justify-center px-4 sm:px-6 pt-[env(safe-area-inset-top)] pb-12 bg-[#0a0f1a] text-white text-center overflow-hidden"
      style={{
        minHeight: minHeight,
        backgroundImage:
