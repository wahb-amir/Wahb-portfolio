    ...
    >
      ...
      {view === "cloud" ? (
        ...
        >
                ...
                <span className="text-xs mt-1">{experience}</span             </motion.div>
            )
          )}
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6 z-20">
          {skills.map(({ name, icon: Icon, color, experience }) =>            <div
              key={name}
            ...
            >
              ...
              <span className="text-xs text-cyan-400">{experience}</span           </div>
          ))}
        </div>
      )}
