...
export default function SkillsCloud() {
  return (
    <section
      id="skills"
      className="relative py-20 flex flex-col items-center bg-gradient-to-tr from-[#0f172a] via-[#1e293b] to-[#0f172a] rounded-3xl shadow-lg max-w-xl mx-auto min-w-fit"
    >
