...
export default function SkillsCloud() {
  ...
  return (
    <section
      id="skills"
      className="relative flex flex-col justify-start items-center min-h-screen px-4 sm:px-6 text-center bg-[#0a0f1a] text-white overflow-hidden pt-[env(safe-area-inset-top)]" bg-[#0a0f1a] text-white" overflow-hidden pt-[env(safe-area-inset-top)] pb-16"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 flex flex-row items-center justify-center gap-6 mt-12 mb-8 sm:mb-12">
        <button
          onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
          aria-label="Scroll Up"
          className="bg-transparent hover:scale-110 transition-transform duration-300"
        >
        ...
        <button
          ...
          className="bg-transparent animate-pulse hover:scale-110 transition-transform duration-300"
        >
