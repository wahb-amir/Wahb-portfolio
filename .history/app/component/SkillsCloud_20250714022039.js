...
export default function SkillsCloud() {
  return (
    <section
      id="skills"
      className="relative py-20 flex flex-col items-center   bg-gradient-to-br from-[#0a0f1a] via-[#001e3c] to-[#003366]  shadow-lg max-w-xl mx-auto min-w-full"
    >
      <CustomParticles
        colors={["#0099cc", "#007acc", "#005f99", "#004466", "#ffffff"]}
      />
