    ...
    >
      ...
      >
        ...
        <p className="text-center text-lg text-gray-700 dark:text-slate-300 max-w-3xl mx-auto mb-12">
          ...
          about building high-performance web apps. In just 115 days, I’ve gone
          from learning HTML to deploying full-stack applications with React,
          Next.js, Node.js, and MongoDB — hosted on my own Linux VPS.
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-16">
          <StatCard label="Days of Learning" value={a} />
