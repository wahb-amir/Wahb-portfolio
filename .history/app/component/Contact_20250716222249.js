...
export default function ContactForm() {
      ...
      <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
        ...
        <div className="relative h-12 w-full">
          <button
            ...
            className={`w-full h-full rounded-lg font-medium tracking-wide transition-all duration-300 text-black overflow-hidden relative z-10 ${
              status === "sending"
  ...
  exit={{ opacity: 0 }}
  style={{ transform: 'translateX(-100%)' }} // keeps it from going outside
>
  🚚📨
</motion.div>
