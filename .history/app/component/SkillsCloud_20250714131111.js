  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-4 sm:top-6 left-1/2 transform -translate-x-1/2 z-30"
        aria-label="Scroll Up"
      >
        <ChevronUpIcon className="w-8 h-8 text-cyan-300 hover:scale-110 transition-transform duration-300" />
      </button>
      ...
      >
        <ChevronDownIcon className="w-8 h-8 text-cyan-300 animate-pulse hover:scale-110 transition-transform duration-300" />
      </button>
    </section>
  );
}
