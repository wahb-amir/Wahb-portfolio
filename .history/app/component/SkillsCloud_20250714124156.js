...
export default function SkillsCloud() {
  ...
  return (
    ...
    >
      ...
      {/* 🧠 Title */}
      <h2 className="relative z-20 text-2xl sm:text-4xl font-extrabold mb-12 text-white">
        What I Work With
      </h2>
      ...
      >
        {skillsWithPosition.map(({ name, icon: Icon, x, y, color }, i) => (
          <motion.div
            ...
            className="absolute flex items-center justify-center cursor-pointer rounded-full shadow-lg w-[60px] h-[60px] xs:w-[40px] xs:h-[40px] bg-gray-900"
            style={{
              top: centerOffset,
              left: centerOffset,
              boxShadow:
