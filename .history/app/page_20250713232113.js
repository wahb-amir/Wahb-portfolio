...
import { loadLinksPreset } from "tsparticles-preset-links"; // ✅ only this!

const particlesInit = async (engine) => {
  await loadLinksPreset(engine); // ✅ only this, no loadFull
};

const particlesOptions = {
  preset: "links",
  background: { color: "transparent" },
  fullScreen: { enable: false }, // ✅ let your layout control size
};
