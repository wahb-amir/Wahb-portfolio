...
export default function Home() {
  ...
  const particlesOptions = {
    fullScreen: { enable: false },
    background: { color: "#000000" }, // dark bg to make sure you see something
    particles: {
      number: {
        value: 50,
        density: {
  ...
  return (
    <main className="relative h-screen bg-black">
      ...
      />
      <h1 className="relative z-10 text-white text-center pt-40 text-3xl font-bold">
        🚀 Particles Test – You should see something!
      </h1>
    </main>
  );
}
