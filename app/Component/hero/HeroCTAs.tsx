  ...
  return (
    <div className="mt-6 flex flex-wrap items-center gap-2.5 justify-center text-sm font-medium tracking-wide">
      ...
      >
        ...
        <svg
          className="w-4 height-4 opacity-90"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2.2"
      ...
      >
        <svg
          className="w-3.5 h-3.5 opacity-60 group-hover:translate-y-0.5 group-hover:opacity-100 transition-all duration-200"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2.5"
      ...
      {modalOpen && (
        <div
          className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md transition-opacity duration-200"
          role="dialog"
          aria-modal="true"
        >
          <div
            ...
            <div className="p-5">
              <div className="space-y-2">
                {MEETING_OPTIONS.map((opt, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 border transition-transform duration-200 group-hover/card:scale-105 ${t.iconBg} ${t.iconBorder} ${t.text}`}
                      >
                        {opt.icon}
                      </div>
                      ...
                      <div
                        className={`text-xs font-bold ${t.text} opacity-80 pr-1`}
                      >
                        {opt.duration}m
                      </div>
              ...
              >
                <button className="w-full py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold text-xs tracking-wide flex items-center justify-center gap-1.5 shadow-[0_4px_12px_rgba(37,99,235,0.2)] transition-all duration-150 active:scale-[0.98]">
                  ...
                  <span>
                    Book {MEETING_OPTIONS[selected].duration}m ·{" "}
                    {MEETING_OPTIONS[selected].label}
                  </span>
                  <svg
                    className="w-3 h-3"
                    viewBox="0 0 24 24"
              ...
              <p className="text-[10px] text-zinc-600 text-center mt-3 tracking-normal">
                Opens cal.com · Free · No spam
              </p>
            </div>
          </div>
        </div>
