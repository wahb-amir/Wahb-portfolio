...
export default function ProjectServer() {
  return (
    <>
      ...
      <section
        id="project-section"
        className="relative flex flex-col justify-start items-center px-4 xs:px-6 text-center py-12 gap-8 text-slate-900 overflow-hidden pt-[env(safe-area-inset-top)] dark:text-white bg-white/58 backdrop-blur-md border border-slate-200/75 rounded-2xl shadow-sm shadow-slate-200/60 dark:bg-slate-900/40 dark:border-slate-800/60 dark:shadow-none my-12 mx-4 md:mx-auto max-w-7xl"
