 ...
 * Renders static about data passed from the server component.
 * No IndexedDB, no fetch, no fallback, no versioning.
 */
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${mono.className} flex items-center gap-3 mb-6`}>
      <span className="w-8 h-px inline-block" style={{ background: "#00e5c3" }} />
      <span
...
export default function About({ data }: { data: AboutContent }) {
  ...
  return (
    <section
      ...
      className="relative w-full min-h-screen overflow-hidden bg-gradient-to-b from-[#00b1ff88] to-[#00bfff44] text-black dark:text-white"
    >
      <style>{`
      ...
      <div
        ...
        style={{ background: isDark ? "rgba(5,12,24,0.45)" : "rgba(240,249,255,0.35)" }}
      />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8 py-24">
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <motion.div variants={fadeUp} className="flex-shrink-0 w-full lg:w-1/2 flex flex-col items-center">
              <h2
                id="about-heading"
            ...
            <motion.div variants={fadeUp} className="flex-1 min-w-0">
              <div
                ...
                style={{
                  background: isDark ? "rgba(5,15,30,0.75)" : "rgba(255,255,255,0.75)",
        ...
        >
          ...
          <div
            ...
            style={{
              background: isDark ? "rgba(5,15,30,0.65)" : "rgba(255,255,255,0.65)",
            ...
            <motion.div variants={stagger} className="flex flex-wrap gap-2.5">
              {data.quickFacts.map((fact, i) => (
                <motion.span
                  ...
                  style={{
                    background: i % 3 === 0
                      ? isDark ? "rgba(0,229,195,0.14)" : "rgba(0,229,195,0.15)"
                      : isDark ? "rgba(255,255,255,0.07)" : "rgba(15,23,42,0.06)",
                    borderColor: i % 3 === 0
                      ? "rgba(0,229,195,0.4)"
                      : isDark ? "rgba(255,255,255,0.12)" : "rgba(15,23,42,0.12)",
                    color: i % 3 === 0
                      ? isDark ? "#2dd4bf" : "#0e7490"
                      : isDark ? "#e2e8f0" : "#1e293b",
                  }}
                >
                  <span style={{ color: "#00e5c3", fontSize: "0.6rem" }}>◆</span>
                  {fact}
                </motion.span>
              ))}
            </motion.div>
          ...
          >
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(to bottom, transparent, rgba(0,229,195,0.6) 15%, rgba(0,229,195,0.3) 85%, transparent)",
                }}
                aria-hidden
              />
                    ...
                    >
                      ...
                      <div className="relative flex-shrink-0 mt-1">
                        <div
                          ...
                          style={{
                            borderColor: isNext ? "#f59e0b" : isNow ? "#00e5c3" : "rgba(0,229,195,0.45)",
                            background: isNext
                              ? "rgba(245,158,11,0.25)"
                              : isNow
                              ? "rgba(0,229,195,0.25)"
                              : isDark ? "rgba(5,15,30,0.9)" : "rgba(255,255,255,0.9)",
                            animationDelay: `${idx * 80}ms`,
                            boxShadow: isNow || isNext
                      ...
                      >
                        <div className="flex items-center gap-3 mb-1.5">
                          <span
                            ...
                            style={{
                              color: isNext ? "#f59e0b" : isNow ? "#00e5c3" : isDark ? "#64748b" : "#94a3b8",
                            }}
                          >
                            {t.title}
                          </span>
                          {(isNow || isNext) && (
                            <span
                              ...
                              style={{
                                background: isNext ? "rgba(245,158,11,0.12)" : "rgba(0,229,195,0.1)",
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 60px -20px rgba(0,229,195,0.15), 0 4px 24px rgba(0,0,0,0.18)",
              }}
            >
              <span
                aria-hidden
                className="absolute left-0 top-6 bottom-6 w-[3px] rounded-full"
                style={{ background: "linear-gradient(to bottom, #00e5c3, #06b6d4)" }}
              />
              <span
                aria-hidden
