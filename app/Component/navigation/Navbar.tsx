...
const Navbar = () => {
  ...
  // The hamburger/X bar color:
  //   • Dark theme  → always white (visible on dark backgrounds)
  //   • Light theme → always black (visible on both the transparent nav AND
  //                   the white/95 drawer backdrop when menu is open)
        ...
        >
          ...
          <div className="flex-1 flex justify-end items-center gap-3">
            <div className="hidden md:flex gap-2">
              <IconButton
                icon={faGithub}
                onClick={() => window.open("https://github.com/wahb-amir", "_blank")}
              />
            ...
            >
              <motion.span
                ...
                className={`block w-6 h-0.5 rounded-full ${barColor}`}
              />
              <motion.span
          ...
          >
            <div className="flex flex-col gap-3 max-w-sm mx-auto">
              ...
              <div className="grid grid-cols-2 gap-3 mt-4">
                <button
                  onClick={toggleTheme}
                  className="flex items-center justify-center gap-2 p-5 rounded-2xl bg-slate-100 dark:bg-white/5 font-bold shadow-sm"
                >
