  ...
  return (
    ...
    text-black dark:text-white
      ...
      >
        ...
        <h1
          className={`text-[45px] font-bold mb-8 top-5 ${isDark ? "text-white" : "text-black"
            }`}
        >
          My Projects
        </h1>
        ...
        <h2
          className={`text-xl sm:text-2xl font-semibold mb-4 ${isDark ? "text-cyan-300" : "text-blue-600"
            }`}
        >
          E-commerce Store
        </h2>
